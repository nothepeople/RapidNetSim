...
from base_conf_template.generate_tasks import generate_custom_tasks, generate_16384_custom_tasks
...
if __name__ == '__main__':
    ...
    joint_scheduler = 'hw_oxc_allreduce_nopeer'

    # [(arriving_time, model_size at every NIC, task_occupied_NIC_num), ...]
    # task_list = generate_16384_custom_tasks(20, exponential_beta = 0.00003, fixed_model_size = 8)
    task_list = [(0, 8, 16384)]
    ...
    content = template.render(
        ...
        topo_type = 'clos',
        find_path_method = 'hw_oxc_allreduce_nopeer',
        joint_scheduler = joint_scheduler,
        measure_sampling_interval = 10,

        downlinks = downlinks,

        find_next_hop_method = 'balance',
